...
public class TP2_sala_de_aula_interrupcoes {
	
		final int tamanhoHD= 10000; // 40k words
		final int tamanhoRam=1000;// quantidade de blocos => 4k palavras
		final int tamanhoCache1 = 16; // quantidade de blocos => 32 palavras
		final int tamanhoCache2 = 32; // quantidade de blocos => 64 palavras
		...
		public static void main(String[] args){
			new TP2_sala_de_aula_interrupcoes();
		}
		
		public TP2_sala_de_aula_interrupcoes(){
			montarRam();
