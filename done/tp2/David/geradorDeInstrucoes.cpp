...
#define REPETICOES 40 /* (0 <= REPETICOES <= 100) Porcentagem que representa a quantidade de blocos de FOR repetidos dentro do NUM_INS.
...
#define QUANTIDADE_DE_ENDERECOS 1 //Numero de enderecos na memoria RAM sobre os quais seu OPCODE (unico por linha) ira' atuar.
