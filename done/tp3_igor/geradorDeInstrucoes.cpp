...
#define TAM_FOR 10 //Tamanho dos blocos de instrucoes.

#define REPETICOES 50 /* (0 <= REPETICOES <= 100) Porcentagem que representa a quantidade de blocos de FOR repetidos dentro do NUM_INS.
/*-> O mesmo bloco (FOR) aparecera' "REPETICOES(%)" da quantidade total de blocos (FORs), nao necessariamente
em sequencia.
*/

#define TAM_MEM 64 //Tamanho da RAM
#define NUM_INS 900 //Quantidade de instrucoes -> Maior que o TAM_FOR (vide item 2 das observacoes).
...
int main() {
	...
	ofstream instrucoes;
	instrucoes.open("interruptions.txt");
	// instrucoes.open("for_45_rate_70_mem_512.txt");
