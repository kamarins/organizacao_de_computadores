...
#define REPETICOES 50 /* (0 <= REPETICOES <= 100) Porcentagem que representa a quantidade de blocos de FOR repetidos dentro do NUM_INS.-> O mesmo bloco (FOR) aparecera' "REPETICOES(%)" da quantidade total de blocos (FORs), nao necessariamente em sequencia.*/

#define TAM_MEM 1000 //Tamanho da RAM
#define NUM_INS 100 //Quantidade de instrucoes -> Maior que o TAM_FOR (vide item 2 das observacoes).
...
void geraInstrucao(){
	...
	//instrucoes.open("interrupcao.txt");
